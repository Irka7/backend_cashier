          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{ asset('gentelella-master') }}/images/img.jpg" alt="{{ asset('gentelella-master') }}." class="img-circle profile_img">
              </div>
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
                      <a class="dropdown-item">
                        ...
                        <span class="message">
                          Film festivals used to be do-or-die moments for movie makers. They were where{{ asset('gentelella-master') }}.
                        </span>
                      </a>
                    </li>
                    <li class="nav-item">
